...
| Phase | 名称 | 目的 | 状態 |
|-------|------|------|------|
| 31 | Unit Production Queue | TC / Barracks で複数ユニット予約 + Barracks Q | ⬜ 未着手 |
| 32 | Idle Unit UX | 待機村民・軍の表示 + 選択ホットキー | ⬜ 未着手 |
...
4. M2.6 全完了後 → [06_M3_MILITARY_PHASES.md](06_M3_MILITARY_PHASES.md) Phase 35 へ
