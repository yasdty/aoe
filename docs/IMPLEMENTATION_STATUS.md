...
>
> **最終更新:** Phase 19 完了（Lumber Camp + Wood Drop-off）。Foundation Milestone 1 完了。M2 Economy 進行中。
>
...
| 次に何を作るべき？ | **Phase 20 Gold + Stone**（Milestone 2 Economy）— [docs/README.md](README.md) |
