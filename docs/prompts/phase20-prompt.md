...
**Gold Mine / Stone Mine から採掘し TC に搬入** — AoE2 の採石場・金鉱と同様、マップ上のノードを村民が採掘する。Deposit 先は **TownCenter のみ**（Mining Camp は **Phase 23 / M2.5**）。
...
- Gold / Stone の **Drop-off 拠点**（Lumber Camp パターンは **Phase 23 / M2.5**）
...
Phase 20 のみ実装。**Phase 21 以降（M2.5 Economy Polish）** に触れない。
