...
- [x] **Villager** 左クリック → 左下に名前 + HP（攻撃力なし）
- [x] **Militia** 左クリック → 名前 + HP + Attack
- [x] **Tree** 左クリック → `Wood: N`
- [x] **Berry / Deer / Sheep** → `Food: N`
- [x] **Gold / Stone Mine** → `Gold: N` / `Stone: N`
- [x] **TC / Barracks / Farm / House / Camp** → 名前 + HP
- [x] 複数ユニット矩形選択 → 従来どおり（Info Panel は非表示で OK）
- [x] 右クリック Gather / Attack / Move 回帰
- [ ] Console エラーなし（Play 確認待ち）
- [x] `docs/IMPLEMENTATION_STATUS.md` / `04_M2_5` Phase 25 を ✅
