...
> **次:** [04_M2_5_ECONOMY_POLISH_PHASES.md](04_M2_5_ECONOMY_POLISH_PHASES.md)（Phase 21〜28）→ [05_M2_6_RTS_UX_PHASES.md](05_M2_6_RTS_UX_PHASES.md)（29〜32）→ M3（33〜）— [docs/README.md](README.md)
...
| 19 | Lumber Camp |
| 20 | Gold & Stone |
| 21〜28 | **M2.5** — Gather Repeat / Farm+Spawn / Mining Camp / Hunting / Boar / Mill / Aggro / CPU 4 Resources |
| 29〜32 | **M2.6** — Unit Production Queue / Idle UX / Rally Point / Control Groups |
| 33 | Archer |
| 34 | Spearman |
| 35 | Cavalry |
| 36 | Counter System |
