...
**M6（次）— 4 人・2v2・大マップ・ゲームプレイ補完・Fog:** [docs/10_M6_MULTIPLAYER_FOUNDATION.md](docs/10_M6_MULTIPLAYER_FOUNDATION.md)

| Phase | 内容 |
|-------|------|
| 57 | Entity ID & PlayerId ✅ |
| 58 | CPU Command Queue ✅ |
| 59 | 4 人マッチ（人間1 + CPU3）✅ |
| 60 | 2v2（人間+CPU vs CPU×2）— **次** |
| 61 | 大型マップ |
| 62 | 敵 HP 表示（敵選択・HP バー） |
| 63 | 建物修理 |
| 64 | 複数 Villager 建設（速度加速） |
| 65 | Fog of War |
| 66 | 決定論（LAN 前・後回し可） |
