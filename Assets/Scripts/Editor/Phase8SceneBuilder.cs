...
{
    public static class Phase8SceneBuilder
    {
        const string ScenePath = "Assets/Scenes/Phase8.unity";
        ...
        [MenuItem("AoE/Setup Phase8 Scene", true)]
        static bool ValidateSetupPhase8Scene() => !EditorApplication.isPlaying;

        [MenuItem("AoE/Setup Phase8 Scene")]
        public static void SetupPhase8Scene()
        {
            ...
            Debug.Log("Phase8 scene created at " + ScenePath);
        }
