...
namespace AoE.RTS.Buildings
{
    ...
    public class MiningCamp : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            MiningCampRegistry.Register(this);
        }

        void OnDisable()
        {
            MiningCampRegistry.Unregister(this);
        }
        ...
        void UpdateVisual()
        {
            ...
            Color color = data != null ? data.defaultColor : new Color(0.45f, 0.48f, 0.52f);
...
#if UNITY_EDITOR
            data = AssetDatabase.LoadAssetAtPath<PlacedBuildingData>(GameAssetPaths.DefaultMiningCampData);
#endif
        }
    }
}
